...
protected:
    ...
    std::string big_number4{"-48391025835790328541839049309"};
    std::string big_number5{"-84901240928409248392043045678909876345"};
    ...
    BigInteger<1000> big_int5 = BigInteger<1000>(big_number5);
    ...
    std::string big_int4_times_big_int5
            {"4108458143257311198335562726147027215480712648692379030265547695605"};
    ...
    std::string big_int1_times_big_int2_times_big_int4
            {"-1051662504365167903027407927691094605989616893410712462560445224362040738760182883622729597834189342551085664255347053"};
...
TEST_F(SetupBigIntegersMultiplication, test_multiplication_big_int4_times_big_int5) {
    auto result = big_int4 * big_int5;
    EXPECT_TRUE(result.to_number_string() == big_int4_times_big_int5);
    auto result_reverse = big_int5 * big_int4;
    EXPECT_TRUE(result_reverse.to_number_string() == big_int4_times_big_int5);
}
...
TEST_F(SetupBigIntegersMultiplication, test_multiplication_big_int1_times_big_int4_times_big_int2) {
    auto result = big_int1 * big_int2 * big_int4;
    EXPECT_TRUE(result.to_number_string() == big_int1_times_big_int2_times_big_int4);
    auto result_permuted1 = big_int4 * big_int2 * big_int1;
    EXPECT_TRUE(result_permuted1.to_number_string() == big_int1_times_big_int2_times_big_int4);
    auto result_permuted2 = big_int2 * big_int1 * big_int4;
    EXPECT_TRUE(result_permuted2.to_number_string() == big_int1_times_big_int2_times_big_int4);
    auto result_permuted3 = big_int2 * big_int4 * big_int1;
    EXPECT_TRUE(result_permuted3.to_number_string() == big_int1_times_big_int2_times_big_int4);
}
...
TEST_F(SetupBigIntegersMultiplication, test_multiplication_many_negative_procucts) {
    long long int start{1176247};
    auto multiplicand = BigInteger<64>(start);
    for (int i = 1; i < 1000; ++i) {
        auto string = std::to_string(-i);
